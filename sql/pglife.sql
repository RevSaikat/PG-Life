...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2025 at 04:29 PM
...
INSERT INTO `payment_details` (`id`, `fullname`, `email`, `address`, `city`, `state`, `zipcode`, `nameoncard`, `cardno`, `expmonth`, `expyear`, `cvv`) VALUES
(1, 'Saikat', 'saikatdas.20oct2001@gmail.com', 'Sreemani', 'Kolkata', 'India', 700036, 'Saikat', 2147483647, 'Jan', '0000-00-00', 4984),
(2, 'Chayan', 'sayan@gmail.com', 'Sreemani', 'Kolkata', 'India', 700036, 'Chayan', 2147483647, 'Feb', '0000-00-00', 1025),
(3, '', '', '', '', '', 0, '', 0, '', '0000-00-00', 0);
...
(6, 3, 'Zolo Stays Bengaluru', '12th Main Rd, HAL 2nd Stage, Indiranagar, Bengaluru, Karnataka 560008', 'Experience premium living at Zolo Stays Indiranagar. Perfectly situated in the heart of Bengaluru\'s tech hub, this PG offers modern amenities and a vibrant community. Each room is designed for comfort with ergonomic furniture and high-speed Wi-Fi. Ideal for young professionals and students.', 'male', 12000, 4.5, 4.0, 4.7),
(7, 3, 'Your-Space Bengaluru', 'Hosur Road, Koramangala, Bengaluru, Karnataka 560034', 'Your-Space offers a secure and stylish home away from home. Located in Koramangala, it provides easy access to top colleges and workplaces. Enjoy chef-prepared meals, top-notch security, and regular social events. A perfect blend of privacy and social life.', 'female', 15000, 4.8, 4.5, 4.9),
(8, 4, 'Stanza Living Hyderabad', 'Gachibowli, Hyderabad, Telangana 500032', 'Discover a new way of living at Stanza Living Hyderabad. Our tech-enabled PG in Gachibowli offers a hassle-free experience with professional housekeeping, nutritious meals, and a fun community. Stay close to the biggest IT parks in the city.', 'unisex', 11000, 4.4, 4.1, 4.6),
(9, 4, 'HelloWorld Hyderabad', 'Madhapur, Hyderabad, Telangana 500081', 'HelloWorld Madhapur is more than just a place to stay. It\'s a community-first living space with beautifully designed common areas, gaming zones, and regular events. High-speed internet and professional cleaning included. Your city life, simplified.', 'female', 9500, 4.2, 3.8, 4.5);
...
(11, 6, 'Ritesh Agarwal', 'The Indiranagar location is unbeatable. Zolo makes everything so easy, from bill payments to maintenance requests.'),
(12, 7, 'Priya Sharma', 'I\'ve been staying at Your-Space Koramangala for 6 months now. The food is actually good, and I feel very safe here.'),
(13, 8, 'Abhishek Gupta', 'Stanza Living Gachibowli has a great vibe. The common area is awesome for chilling after work.'),
(14, 9, 'Sneha Reddy', 'HelloWorld Madhapur is a fantastic place. The staff is very helpful and the weekly events are a lot of fun!');
...
(29, 'saikatdas.20102001@gmail.com', 'b5eec248ed40a737733d6ea761a3fac313131ee4', 'Saikat Das', '8585871186', 'male', 'Narula Institute of Technology');
